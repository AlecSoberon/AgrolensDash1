...
function openModal(alertId) {
  ...
  content.innerHTML = `
    ...
    <div class="evidence-grid">
      <figure class="evidence with-image"><img src="assets/aerial-overview.jpg" alt="Vista general del fundo" /><figcaption>Vista general del fundo</figcaption></figure>
      <figure class="evidence with-image"><img src="assets/anomaly-zone.jpg" alt="Zoom de la zona prioritaria" /><figcaption>Zoom de la zona prioritaria</figcaption></figure>
      <figure class="evidence with-image"><img src="assets/healthy-vs-weak.jpg" alt="Comparación con una referencia sana" /><figcaption>Comparación con una referencia sana</figcaption></figure>
      <figure class="evidence with-image"><img src="assets/field-inspection.jpg" alt="Validación en campo" /><figcaption>Qué se valida en campo</figcaption></figure>
    </div>
